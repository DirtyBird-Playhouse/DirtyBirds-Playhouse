...
This downloads the video in best available quality as MP4 to your **Downloads** folder (`~/Downloads`).
...
- Downloads are saved to your **Downloads** folder (`~/Downloads`) by default
